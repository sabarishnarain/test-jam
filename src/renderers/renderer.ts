...
export default class renderers {
  ...
  public static editTest(res: any, currentTest: any, project: any, history: any,
                         otherTestsInProject: any, error?: string, success?: string) {
    res.render('editTest', {currentTest, project, history, otherTestsInProject, error, success});
  }
